...
3. **Angular 18+** is required (`peerDependencies`: `@angular/*` `>=18 <23`). The library is compiled with Angular 22; validate your major with `npm run consumer:smoke` (Angular 22), `npm run consumer:smoke:ng18` (Angular 18), or a local install of the packaged tarball.
